...
@section('content')
    ...
    {{-- Searbar + filter --}}
    <form>
        <div id='searcfil' class="flex">
            <label for="search-dropdown" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Your
                Email</label>
            <button id="dropdown-button" data-dropdown-toggle="dropdown"
                class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
                type="button"><svg aria-hidden="true" class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20"
            ...
            <div id="dropdown"
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                    <li>
                        <button type="button"
                            class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Gaji
                            (tertinggi)</button>
                    </li>
                    <li>
                        <button type="button"
            ...
            <div class="relative w-full">
                <input type="search" id="search-dropdown"
                    ...
                    placeholder="Pencarian Lokasi" required>
                <button type="submit"
    ...
    <div class="grid grid-cols-6 gap-4 p-8">
        ...
        <div class="max-w-xs flex flex-col items-center justify-center gap-8 rounded-3xl shadow-2xl p-4 py-8 bg-white">
            ...
            <h2 class="text-2xl font-semibold tracking-wide">Abdul Ghafur</h2>
            <div class="p-2 bg-slate-300 rounded-md">
                <div class="flex items-center justify-between gap-2">
                    ...
                    <div class="text-center">
                        <div class="mb-1 text-xs"> Surabaya</div>
                    </div>
                </div>
                <div class="flex items-center justify-between gap-2">
                    ...
                    <div class="text-center">
                        <div class="mb-1 text-xs"> Rp.300.000</div>
                    </div>
                </div>
            </div>
            <button type="button"
        ...
        {{-- isi 2 --}}
        <div class="max-w-xs flex flex-col items-center justify-center gap-8 rounded-3xl shadow-2xl p-4 py-8 bg-white">
            <img src="{{ ('img/mitra_2.png') }}" alt="" class="object-cover object-center w-36 rounded-full ">
            <h2 class="text-2xl font-semibold tracking-wide">Abdul Ghafur</h2>
            <div class="p-2 bg-slate-300 rounded-md">
                <div class="flex items-center justify-between gap-2">
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
        ...
        {{-- isi 3 --}}
        <div class="max-w-xs flex flex-col items-center justify-center gap-8 rounded-3xl shadow-2xl p-4 py-8 bg-white">
            <img src="{{ ('img/mitra_3.png') }}" alt="" class="object-cover object-center w-36 rounded-full ">
            <h2 class="text-2xl font-semibold tracking-wide">Abdul Ghafur</h2>
            <div class="p-2 bg-slate-300 rounded-md">
                <div class="flex items-center justify-between gap-2">
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
        ...
        {{-- isi 4 --}}
        <div class="max-w-xs flex flex-col items-center justify-center gap-8 rounded-3xl shadow-2xl p-4 py-8 bg-white">
            <img src="{{ ('img/mitra_4.png') }}" alt="" class="object-cover object-center w-36 rounded-full ">
            <h2 class="text-2xl font-semibold tracking-wide">Abdul Ghafur</h2>
            <div class="p-2 bg-slate-300 rounded-md">
                <div class="flex items-center justify-between gap-2">
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
        ...
        {{-- isi 5 --}}
        <div class="max-w-xs flex flex-col items-center justify-center gap-8 rounded-3xl shadow-2xl p-4 py-8 bg-white">
            <img src="{{ ('img/mitra_5.png') }}" alt="" class="object-cover object-center w-36 rounded-full ">
            <h2 class="text-2xl font-semibold tracking-wide">Abdul Ghafur</h2>
            <div class="p-2 bg-slate-300 rounded-md">
                <div class="flex items-center justify-between gap-2">
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
        ...
        {{-- isi 6 --}}
        <div class="max-w-xs flex flex-col items-center justify-center gap-8 rounded-3xl shadow-2xl p-4 py-8 bg-white">
            <img src="{{ ('img/mitra_6.png') }}" alt="" class="object-cover object-center w-36 rounded-full ">
            <h2 class="text-2xl font-semibold tracking-wide">Abdul Ghafur</h2>
            <div class="p-2 bg-slate-300 rounded-md">
                <div class="flex items-center justify-between gap-2">
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
